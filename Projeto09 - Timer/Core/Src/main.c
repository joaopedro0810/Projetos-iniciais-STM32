...
/**
 *  Ele já estoura em 1us
 */
void delay_us(uint32_t us)
{
	__HAL_TIM_SET_COUNTER(&htim2, 0);			/**< Setando o contador em zero */
	while(__HAL_TIM_GET_COUNTER(&htim2) < us);	/**< Fica preso até o valor de us seja verdadeiro */
}
