...
osThreadId EnviaSerial1Handle;
osThreadId EnviaSerial2Handle;
osThreadId EnviaSerial3Handle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* definition and creation of EnviaSerial1 */
  ...
  /* definition and creation of EnviaSerial2 */
  ...
  /* definition and creation of EnviaSerial3 */
...
/* USER CODE BEGIN Header_EnviaSerial1_fun */
/**
  * @brief  Function implementing the EnviaSerial1 thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_EnviaSerial1_fun */
void EnviaSerial1_fun(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
...
/* USER CODE BEGIN Header_EnviaSerial2_fun */
/**
* @brief Function implementing the EnviaSerial2 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_EnviaSerial2_fun */
void EnviaSerial2_fun(void const * argument)
{
  /* USER CODE BEGIN EnviaSerial2_fun */
  /* Infinite loop */
  for(;;)
  {
  ...
  /* USER CODE END EnviaSerial2_fun */
}

/* USER CODE BEGIN Header_EnviaSerial3_fun */
/**
* @brief Function implementing the EnviaSerial3 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_EnviaSerial3_fun */
void EnviaSerial3_fun(void const * argument)
{
  /* USER CODE BEGIN EnviaSerial3_fun */
  /* Infinite loop */
  for(;;)
  {
  ...
  /* USER CODE END EnviaSerial3_fun */
}
